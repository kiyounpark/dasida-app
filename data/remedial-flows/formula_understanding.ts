  ...
  nodes: {
    ...
    'fu_step1_C_check': {
      ...
      options: [
        ...
        { id: 'wrong1',  text: '10', isCorrect: false, nextNodeId: 'fu_step1_C_remedy', weaknessId: 'basic_concept_needed' },
        { id: 'wrong2',  text: '계수와 무관하다', isCorrect: false, nextNodeId: 'fu_step1_C_remedy', weaknessId: 'basic_concept_needed' },
      ],
      dontKnowNextNodeId: 'fu_step1_A_easy',
    },
    'fu_step1_C_remedy': {
    ...
    'fu_step2_C_check': {
      ...
      options: [
        ...
        { id: 'wrong1',  text: '0', isCorrect: false, nextNodeId: 'fu_step2_C_remedy', weaknessId: 'basic_concept_needed' },
        { id: 'wrong2',  text: '+9', isCorrect: false, nextNodeId: 'fu_step2_C_remedy', weaknessId: 'expansion_sign_error' },
      ],
      dontKnowNextNodeId: 'fu_step2_B_easy',
    },
    'fu_step2_C_remedy': {
    ...
    'fu_step3_A_check': {
      ...
      options: [
        ...
        { id: 'wrong1',  text: '-4', isCorrect: false, nextNodeId: 'fu_step3_A_remedy', weaknessId: 'basic_concept_needed' },
        { id: 'wrong2',  text: '7', isCorrect: false, nextNodeId: 'fu_step3_A_remedy', weaknessId: 'basic_concept_needed' },
      ],
    ...
    'fu_step3_C_check': {
      ...
      options: [
        ...
        { id: 'wrong1',  text: '0', isCorrect: false, nextNodeId: 'fu_step3_C_remedy', weaknessId: 'basic_concept_needed' },
        { id: 'wrong2',  text: '2', isCorrect: false, nextNodeId: 'fu_step3_C_remedy', weaknessId: 'basic_concept_needed' },
      ],
      dontKnowNextNodeId: 'fu_step3_A_easy',
    },
    'fu_step3_C_remedy': {
