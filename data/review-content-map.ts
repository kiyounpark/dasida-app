    ...
    thinkingSteps: [
      {
        ...
        choices: [
          { text: '표준형으로 바꿀 필요 없다', correct: false, feedback: '(x−a)²+b 꼴이어야 a와 b가 한눈에 보여요. 표준형이 바로 답을 읽게 해주는 키예요.' },
          { text: '(x−a)²+b 꼴로 먼저 파악한다', correct: true, feedback: '맞아요! 이 꼴이 보이면 최솟값과 그 위치를 그대로 읽을 수 있어요.' },
          { text: 'a와 b는 어차피 같은 값이다', correct: false, feedback: 'a는 위치, b는 값이라 역할이 달라요. 두 글자가 같은 자리에서 다른 일을 한다고 생각해봐요.' },
        ],
      },
      {
        title: '최솟값은 상수항 b',
        ...
        choices: [
          ...
          { text: '최솟값은 a+b이다', correct: false, feedback: '두 글자를 더할 이유가 없어요. 제곱 항이 0이 되는 순간을 따라가면 b만 남아요.' },
        ],
      },
      {
        title: '최솟값이 되는 x는 a',
        ...
        choices: [
          ...
          { text: 'x=0일 때 항상 최솟값이다', correct: false, feedback: 'x=0이 늘 최솟값을 주지는 않아요. 제곱 항이 0이 되는 x가 a라는 점에서 다시 출발해봐요.' },
        ],
      },
    ],
  },
    ...
    thinkingSteps: [
      {
        ...
        choices: [
          { text: 'f(x)=0으로 놓는다', correct: false, feedback: 'f(x)=0은 함수의 영점을 구하는 방정식이에요. 극값을 찾으려면 도함수가 0이 되는 지점을 봐야 해요.' },
          { text: "f'(x)=0으로 놓는다", correct: true, feedback: '맞아요! 접선 기울기가 0인 지점이 극값 후보예요.' },
          { text: "f''(x)=0으로 놓는다", correct: false, feedback: 'f\'\'=0은 변곡점 후보를 찾을 때 써요. 극값 후보는 한 단계 위인 f\'=0이에요.' },
        ],
      },
      {
        title: 'x 값 구하기',
        ...
        choices: [
          { text: 'x 값은 부호에 관계없이 하나다', correct: false, feedback: '방정식의 차수에 따라 후보가 여러 개일 수 있어요. ±까지 모두 챙겨야 빠뜨리지 않아요.' },
          { text: '방정식을 풀어 후보 x 값을 모두 구한다', correct: true, feedback: '맞아요! 후보를 모두 모아둬야 극대·극소를 빠짐없이 검토할 수 있어요.' },
          { text: 'x는 항상 양수만 구한다', correct: false, feedback: '음수 해가 극값일 수도 있어요. 부호를 가리지 말고 모두 후보로 두세요.' },
        ],
      },
      {
        ...
        choices: [
          { text: "f'(x)에 x를 대입한다", correct: false, feedback: 'f\'에 넣으면 다시 0이 나올 뿐이에요. 실제 극값은 원함수 f에 넣어야 보여요.' },
          { text: '원함수 f(x)에 x를 대입한다', correct: true, feedback: '맞아요! 후보 x를 원래 함수에 다시 넣어야 극값이 나와요.' },
          { text: '대입 없이 x만 답으로 쓴다', correct: false, feedback: 'x는 위치고, 극값은 그 위치에서의 함수값이에요. 대입 한 단계가 빠져 있어요.' },
        ],
      },
    ],
  },
    ...
    thinkingSteps: [
      {
        ...
        choices: [
          ...
          { text: '인원이 많으면 순열, 적으면 조합', correct: false, feedback: '기준은 인원 수가 아니라 순서의 의미예요.' },
          { text: '무조건 조합으로 계산한 뒤 순서를 곱한다', correct: false, feedback: '한 가지 흐름이긴 하지만 정석은 처음부터 P 또는 C를 골라 쓰는 거예요.' },
        ],
      },
      {
        ...
        choices: [
          { text: 'C(n,r)=P(n,r)/r!', correct: true, feedback: '맞아요! 순서를 지우는 r! 한 번이 둘의 차이예요.' },
          { text: 'C(n,r)=P(n,r)×r!', correct: false, feedback: '곱하면 같은 경우를 더 부풀려요. 나누는 방향이 맞아요.' },
          { text: 'C(n,r)=n!/(n+r)!', correct: false, feedback: '분모는 (n−r)!이에요. 부호 하나가 결과를 완전히 바꿔놓아요.' },
        ],
      },
      {
        title: '중복이 있는 경우',
        ...
        choices: [
          ...
          { text: '중복이 있으면 항상 n!로 계산한다', correct: false, feedback: '중복 종류에 따라 nʳ 또는 H(n,r)을 써야 해요. n!만 쓰면 어긋나요.' },
          { text: '중복 조합은 C(n,r)+n이다', correct: false, feedback: '그 형태는 일반적인 공식이 아니에요. H(n,r)=C(n+r−1, r)를 써야 해요.' },
        ],
      },
    ],
  },
    ...
    thinkingSteps: [
      {
        ...
        choices: [
          { text: '"적어도"가 나오면 여사건 1-P(Aᶜ)를 활용한다', correct: true, feedback: '맞아요! 여사건 한 번이 셀 일을 크게 줄여줘요.' },
          { text: '"적어도"가 나와도 직접 경우의 수를 센다', correct: false, feedback: '직접 세도 되지만, 여사건이 훨씬 빠르고 안전해요.' },
          { text: '여사건은 P(A)×2와 같다', correct: false, feedback: '여사건은 1−P(A)예요. 곱하기 2와는 관련이 없어요.' },
        ],
      },
      {
        title: '조건부확률 공식',
        ...
        choices: [
          { text: 'P(A|B)=P(A∩B)/P(B)', correct: true, feedback: '맞아요! 조건부확률의 정의 그 자체예요.' },
          { text: 'P(A|B)=P(A)/P(B)', correct: false, feedback: '분자가 P(A)가 아니라 P(A∩B)예요. 조건이 좁힌 만큼 교집합이 자리해야 해요.' },
          { text: 'P(A|B)=P(A)×P(B)', correct: false, feedback: '그건 두 사건이 독립일 때의 P(A∩B)예요. 조건부확률 공식과는 달라요.' },
        ],
      },
      {
        title: '독립 사건 판단',
        ...
        choices: [
          ...
          { text: 'P(A∩B)=P(A)+P(B)이면 독립', correct: false, feedback: '그 식은 일반적으로 성립하지 않아요. 독립의 기준은 곱의 형태예요.' },
          { text: '두 사건은 항상 독립이다', correct: false, feedback: '독립인 경우는 곱의 식이 성립할 때뿐이에요. 일반적으로는 종속도 흔해요.' },
        ],
      },
    ],
  },
    ...
    thinkingSteps: [
      {
        ...
        choices: [
          ...
          { text: '이항분포의 평균=np², 분산=npq²', correct: false, feedback: '지수가 한 단계 어긋났어요. 평균은 np, 분산은 npq예요.' },
          { text: '이항분포의 평균과 분산은 같다', correct: false, feedback: '평균은 np, 분산은 npq라 보통 다른 값이에요. 같아지는 건 특정 p에서만이에요.' },
        ],
      },
      {
        title: 'Z 표준화 계산',
        ...
        choices: [
          ...
          { text: 'Z=(X+μ)/σ로 계산한다', correct: false, feedback: '부호가 반대예요. 평균을 빼야 분포의 중심이 0으로 옮겨져요.' },
          { text: 'Z=X×σ-μ으로 계산한다', correct: false, feedback: '표준화는 빼고 나누는 형태예요. 곱하기로는 분포가 정렬되지 않아요.' },
        ],
      },
      {
        title: '정규분포표 읽기',
        ...
        choices: [
          { text: '표는 P(0≤Z≤z)를 주므로 0.5에서 더하거나 뺀다', correct: true, feedback: '맞아요! 표 값과 0.5의 관계만 잘 잡으면 다양한 확률을 모두 구할 수 있어요.' },
          { text: '표는 P(Z≤z) 전체를 직접 준다', correct: false, feedback: '보통의 표는 0부터 z까지의 면적만 줘요. 전체 누적은 계산이 한 단계 필요해요.' },
          { text: '표 값을 2배 하면 P(Z≥z)가 된다', correct: false, feedback: 'P(Z≥z)는 0.5에서 표 값을 빼는 형태예요. 2배는 다른 양이 돼요.' },
        ],
      },
    ],
  },
