  ...
  g3_diff: {
    ...
    thinkingSteps: [
      ...
      },
      {
        id: 'g3_diff.step2',
        title: '합성함수 체인룰',
        body: '함수 안에 또 함수가 든 식을 합성함수라 해요(예: (x²+1)³). 바깥(겉껍질 ³제곱), 안쪽(속 x²+1)으로 보고, 안쪽을 □라는 한 덩어리로 두면 □³ 이에요. 체인룰은 □³ 을 □ 에 대해 먼저 미분(3□²)한 뒤, □ 자리에 다시 안쪽을 넣고 안쪽 미분을 곱해요.',
        example: '예) f(x)=(x²+1)³ → □=x²+1 두면 □³ → 미분 3□² = 3(x²+1)², 안쪽 미분 2x → f\'(x)=3(x²+1)²·2x=6x(x²+1)²',
        choices: [
      ...
      },
      {
        id: 'g3_diff.step3',
        title: '곱의 미분',
        body: '두 함수가 곱해진 식은 한쪽씩 번갈아 미분해 더해 줘요. 공식: (f·g)\'=f\'g+fg\' — 앞 미분·뒤 그대로 + 앞 그대로·뒤 미분.',
        example: '예) f(x)=x²·(x+1) → 앞 미분 2x·(x+1) + 앞·뒤 미분 x²·1. 2x(x+1)=2x²+2x 분배하면 2x²+2x+x² = 3x²+2x',
        choices: [
