...
import { g3_seq_sum_term_flow } from './remedial-flows/g3_seq_sum_term';
...
import { g3_function_flow } from './remedial-flows/g3_function';
...
export const remedialFlows: Partial<Record<WeaknessId, RemedialFlow>> = {
  ...
  g3_seq_sum_term: g3_seq_sum_term_flow,
