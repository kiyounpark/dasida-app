...
exports.problemData = void 0;
exports.getDiagnosticProblems = getDiagnosticProblems;
exports.problemData = [
    {
        id: 'q1',
        grade: 'g1',
    ...
    },
    {
        id: 'q2',
        grade: 'g1',
        question: '(2x + 3)(x - 4) - (x + 1)(x - 5)를 전개하여 정리한 식에서 x의 계수와 상수항의 합은?',
        choices: ['-12', '-8', '-4', '2', '6'],
        answerIndex: 1,
        topic: '다항식의 연산',
    ...
    },
    {
        id: 'q5',
        grade: 'g1',
        question: 'P(x)를 (x - 2)로 나눈 나머지가 11, (x + 1)로 나눈 나머지가 2일 때, (x - 2)(x + 1)로 나눈 나머지 R(x)=ax+b에서 a×b의 값은?',
    ...
    },
    {
        id: 'q6',
        grade: 'g1',
        question: 'x^2 - 5x + 4 <= 0을 만족하는 정수의 개수를 m, x^2 + 2x - 8 > 0을 만족하는 정수(-5 이상 5 이하)의 개수를 n이라 할 때 m + n의 값은?',
        choices: ['5', '7', '8', '9', '10'],
        answerIndex: 2,
        topic: '이차부등식',
    ...
    },
    {
        id: 'q7',
        grade: 'g1',
        question: '1부터 6까지 숫자 카드에서 3장을 뽑아 세 자리 자연수를 만들 때, 홀수인 경우의 수는?',
    ...
    },
    {
        id: 'q8',
        grade: 'g1',
        question: 'x^2 - 6x + k = 0과 x^2 + 2x - k + 4 = 0이 모두 실근을 가지도록 하는 정수 k의 개수는?',
        choices: ['3', '5', '7', '8', '10'],
        answerIndex: 2,
        topic: '이차방정식',
        diagnosisMethods: ['factoring', 'quadratic', 'unknown'],
    },
    {
        id: 'q9',
        grade: 'g1',
        question: '이차함수 f(x) = -x^2 + 2ax + b가 x=3에서 최댓값 12를 가질 때, f(5)의 값은?',
        choices: ['0', '4', '8', '12', '16'],
        answerIndex: 2,
        topic: '이차함수',
    ...
    },
    {
        id: 'q10',
        grade: 'g1',
        question: '1,2,3,4,5가 적힌 공 5개에서 2개를 꺼내 큰 수를 a, 작은 수를 b라 할 때, x^2 - ax + b = 0이 서로 다른 두 양의 실근을 가지는 경우의 수는?',
        choices: ['5', '6', '7', '9', '10'],
        answerIndex: 3,
        topic: '경우의 수/이차방정식',
    ...
    // ─── 고2 공통 ────────────────────────────────────────────────────
    {
        id: 'g2_q1',
        grade: 'g2',
        question: '집합 A={1,2,3,4,5}, B={2,4,6}일 때, n(A∪B) - n(A∩B)의 값은?',
        choices: ['2', '3', '4', '5', '6'],
        answerIndex: 2,
        topic: '집합',
    ...
    },
    {
        id: 'g2_q5',
        grade: 'g2',
        question: '다항식 f(x)를 (x-1)(x+2)로 나누었을 때 나머지가 2x+1이었다. f(1)의 값은?',
        choices: ['1', '2', '3', '4', '5'],
        answerIndex: 2,
        topic: '나머지정리',
        diagnosisMethods: ['remainder_theorem', 'unknown'],
    },
    {
        id: 'g2_q6',
        grade: 'g2',
        question: 'x에 대한 방정식 x²-4x+k=0이 허근을 가질 때, 정수 k의 최솟값은?',
        choices: ['3', '4', '5', '6', '7'],
        answerIndex: 2,
        topic: '방정식',
...
function getDiagnosticProblems(grade, track) {
    const effectiveGrade = grade === 'unknown' ? 'g1' : grade;
    return exports.problemData.filter((p) => {
        if (p.grade !== effectiveGrade)
            return false;
        if (effectiveGrade === 'g3' && p.track !== track)
            return false;
        return true;
    });
}
