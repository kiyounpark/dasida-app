...
exports.getReviewHeroPrompt = getReviewHeroPrompt;
exports.getReviewThinkingSteps = getReviewThinkingSteps;
...
function getReviewHeroPrompt(weaknessId) {
    return reviewContentMap[weaknessId]?.heroPrompt ?? diagnosisMap_1.diagnosisMap[weaknessId].tip;
}
function getReviewThinkingSteps(weaknessId) {
