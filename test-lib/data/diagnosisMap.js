...
exports.weaknessLabelToId = exports.diagnosisMap = exports.weaknessOrder = void 0;
exports.resolveWeaknessId = resolveWeaknessId;
exports.weaknessOrder = [
...
exports.weaknessLabelToId = exports.weaknessOrder.reduce((acc, id) => {
    acc[exports.diagnosisMap[id].labelKo] = id;
    return acc;
}, {});
function resolveWeaknessId(value) {
    if (!value)
        return undefined;
    if (exports.weaknessOrder.includes(value)) {
        return value;
    }
    return exports.weaknessLabelToId[value];
}
